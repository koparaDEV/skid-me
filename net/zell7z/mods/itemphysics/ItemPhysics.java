package net.zell7z.mods.itemphysics;
...
public class ItemPhysics
{
    ...
    {
        rotation = (double)(System.nanoTime() - tick) / 3000000.0D * (double)1;
    ...
    private static byte getMiniBlockCount(ItemStack stack, byte original)
    {
        return original;
    }

    private static byte getMiniItemCount(ItemStack stack, byte original)
    {
        return original;
    }
}
